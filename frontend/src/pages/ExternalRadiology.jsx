                ...
                <div className="bg-white p-6 rounded shadow">
                    ...
                    <div className="space-y-3">
                        {encounters.map(encounter => (
                            <div
                                key={encounter._id}
                                className="border border-indigo-200 p-4 rounded hover:bg-indigo-50 transition"
                            >
                                <div className="flex justify-between items-start">
                                    ...
                                    <button
                                        ...
                                        className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 flex items-center gap-2 ml-4"
                                    >
                                        <FaPlus /> Order Radiology
                                    </button>
                                </div>
                            </div>
                        ))}
...
export default ExternalRadiology;
