        ...
        <Layout>
            ...
            {completedReceipt && (
                <div className="bg-green-50 border border-green-300 rounded-lg p-4 mb-6 flex items-start gap-3">
                    ...
                    <div>
                        <p className="font-bold text-green-800">Sale Completed!</p>
                        <p className="text-green-700 text-sm">Receipt: {completedReceipt.receiptNumber}</p>
                        <div className="mt-2 flex gap-2">
                            <button onClick={handlePrintReceipt} className="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700 flex items-center gap-1">
                                <FaPrint /> Print
                            </button>
